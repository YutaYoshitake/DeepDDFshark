# python reader.py --filename /d/workspace/yyoshitake/ScanNet/scans/scene0000_01/scene0000_01.sens --output_path data2/scans
...
def main(): # python reader.py --filename 
