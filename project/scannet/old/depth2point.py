...
RGB_PATH = 'data2/scans/scene0314_00/color'
DEPTH_PATH = 'data2/scans/scene0314_00/depth'
POSE_PATH = 'data2/scans/scene0314_00/pose'
MAX_INDEX = 950 # take up to this index of images
...
def plot_3d(xdata, ydata, zdata, color=None, b_min=2, b_max=8, view=(45, 45)):
    ...
    fig.savefig('tes_0.png', dpi=300)
    ax.view_init(elev=0, azim=0)
    fig.savefig('tes_1.png', dpi=300)
    ax.view_init(elev=90, azim=90)
    fig.savefig('tes_2.png', dpi=300)
