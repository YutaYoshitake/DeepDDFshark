...
def export(mesh_file, agg_file, seg_file, meta_file, label_map_file, output_file=None):
    ...
    for obj_id in object_id_to_segs:
        ...
        shape_net_labels.append(object_id_to_shapenet_cat[obj_id]) # 0: ShapeNetのカテゴリ取得のため追記
        scan_net_labels.append(object_id_to_scannet_cat[obj_id]) # 0: ShapeNetのカテゴリ取得のため追記
