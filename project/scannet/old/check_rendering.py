...
# simple scan2cad annotationsの読み込み
...
# ScanNet Scene_id
scene_id = 'scene0000_00' # f'scene{str(0).zfill(4)}_{str(0).zfill(2)}'
...
annotations_dict[scene_id]['cad'] = annotations_dict_tmp # ターゲットではないカテゴリを削除
