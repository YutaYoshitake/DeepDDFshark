...
if __name__=='__main__':
    ...
    instance_id = torch.full_like(instance_id, 3015)



    # Create dir
    basedir = 'rendered_depth_results/'
    ...
    for i in tqdm(range(freq)):
        ...
        est_depth_map = model.render_depth_map(pos, c2w, instance_id, H=512, inverced_depth_map=True)
