...
class deepsdf(nn.Module):
    def __init__(
        ...
        self.norm_layers = norm_layers
        self.latent_in = latent_in
        self.latent_dropout = latent_dropout/home/yyoshitake/works/DeepSDF/project/configs/paper_exp/chair/view5/tes.txt
        self.weight_norm = weight_norm
