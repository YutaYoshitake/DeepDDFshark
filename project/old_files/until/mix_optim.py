...
class test_TaR(pl.LightningModule):
    ...
    def test_step(self, batch, batch_idx):
        ...
        for frame_sequence_idx in range(self.frame_sequence_num):
            ...
            for optim_idx in range(self.test_optim_num[frame_sequence_idx]):
                ...
                if perform_init_est:
                    ...
                    # check_map_torch(check_map_inp[0], f'input_frame_{frame_sequence_idx}_opt_{optim_idx}.png', figsize=[10,2])
                    ...
                    # check_map_torch(check_map_1, 'check_map_1.png', figsize=[10,2])
                    # check_map_1 = []
        ...
        #     check_map_1.append(check_map_i)
        # check_map_1 = torch.cat(check_map_1, dim=1)
        # check_map_torch(check_map_1, f'check_{str(batch_idx).zfill(5)}.png', figsize=[10,2])
...
if __name__=='__main__':
    ...
    args.use_gru = False
    df_net = TaR(args, ddf)
    # checkpoint_path = './lightning_logs/DeepTaR/chair/test_dfnet_depth_first_test/checkpoints/0000003200.ckpt'
    checkpoint_path = './lightning_logs/DeepTaR/chair/test_dfnet_WithxLongTrain/checkpoints/0000010000.ckpt'
