export LC_ALL=C
SINGULARITY_OPTIONS="--bind /d/workspace/yyoshitake -B /disks/local/yyoshitake/ShapeNet/ddf/cabinet/train_data.sfs:/disks/local/yyoshitake/ShapeNet/ddf/cabinet/train_data:image-src=/"
